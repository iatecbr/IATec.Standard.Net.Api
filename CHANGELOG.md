...
- `README.md` — full template documentation: architecture, configuration, prerequisites, Docker, CI/CD, renaming guide, and Template Extension Points table aligned to IATec standard.
- `AGENTS.md` — repository-specific guidance for AI agents working in this codebase.
...
- Initial project structure as a BFF template forked from `IATec.Standard.Net.Api`:
  ...
  - **Persistence** — `PersistenceDependencyInjectionConfig.cs`, empty `DatabaseExtension` (BFF pattern — no direct DB access).
